...
var _edge_runtime_cookies = __webpack_require__(522);
...
var modern_browserslist_target = __webpack_require__(741);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(795);
...
function ensureTestApisIntercepted() {
    if (!testApisIntercepted) {
        ...
        if (process.env.NEXT_PRIVATE_TEST_PROXY === "true") {
            const { interceptTestApis, wrapRequestHandler } = __webpack_require__(531);
            interceptTestApis();
...
const _context = __webpack_require__(879);
const reader = {
    url (req) {
        return req.url;
    },
...
const _context = __webpack_require__(879);
const _fetch = __webpack_require__(726);
...
/******/ var __webpack_exports__ = (__webpack_exec__(864));
